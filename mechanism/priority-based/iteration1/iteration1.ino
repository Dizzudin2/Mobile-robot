...
int Dmax = 30; //ultrasonic sensor max distance
int Dmin = 10; //ultrasonic sensor min distance
...
// Priority Based
  ...
  if(B[max_i] == "avoid obstacle"){
    Serial.println("Lets avoid obstacle");
    stopMove();
    delay(500);
    moveBackward();
    delay(500);
    ...
    Serial.println("Lets find north");
    ...
    Serial.println("Lets move forward");
    moveForward();
  }
}
